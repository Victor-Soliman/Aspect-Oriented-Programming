package com.luv2code.aop_zz_around.aspect;
...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.luv2code.aop_zz_around.service.*.getFortune(..))")
    public Object aroundGetFortune(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable {
        ...
        //  theProceedingJoinPoint : will handle to target method
    ...
    @After("execution(* com.luv2code.aop_zz_around.dao.AccountDAO.findAccounts(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* com.luv2code.aop_zz_around.dao.AccountDAO.findAccounts(..))",
            throwing = "theExc")
    ...
    @Before("com.luv2code.aop_zz_around.aspect.LuvAopExpressions.forDaoPackageNoGetterNoSetter()")
