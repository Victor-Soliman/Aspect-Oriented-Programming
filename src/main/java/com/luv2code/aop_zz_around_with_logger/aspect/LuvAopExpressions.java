...
public class LuvAopExpressions {
    ...
    @Pointcut("execution(* com.luv2code.aop_zz_around_with_logger.dao.*.*(..))")
    public void forDaoPackage() {

    }

    // create pointcut for getter methods
    @Pointcut("execution(* com.luv2code.aop_zz_around_with_logger.*.get*(..))")
    public void forGetterMethods() {

    }

    // create pointcut for setter methods
    @Pointcut("execution(* com.luv2code.aop_zz_around_with_logger.*.set*(..))")
