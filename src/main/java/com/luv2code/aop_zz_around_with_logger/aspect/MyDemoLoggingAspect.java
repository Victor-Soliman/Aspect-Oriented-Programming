...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.luv2code.aop_zz_around_with_logger.service.*.getFortune(..))")
    ...
    @After("execution(* com.luv2code.aop_zz_around_with_logger.dao.AccountDAO.findAccounts(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* com.luv2code.aop_zz_around_with_logger.dao.AccountDAO.findAccounts(..))",
            throwing = "theExc")
