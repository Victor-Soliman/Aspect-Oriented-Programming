...
public class LuvAopExpressions {
    ...
    @Pointcut("execution(* com.luv2code.aop_read_joinPoint.dao.*.*(..))")
    public void forDaoPackage() {

    }

    // create pointcut for getter methods
    @Pointcut("execution(* com.luv2code.aop_read_joinPoint.*.get*(..))")
    public void forGetterMethods() {

    }

    // create pointcut for setter methods
    @Pointcut("execution(* com.luv2code.aop_read_joinPoint.*.set*(..))")
